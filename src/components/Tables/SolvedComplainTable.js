...
const SolvedComplainTable = (props) => {
  ...
  let arr = [];
  useEffect(() => {
    props.getSolvedComplain(start, end, type);
    props.getAcceptedDateList(); // eslint-disable-next-line
  }, []);
  ...
  //   if (date === "all") {
  //     setDate("all");
  //     props.getSolvedComplain("all", type);
  //   } else {
  //     setDate(date);
  //     props.getSolvedComplain(date, type);
  //   }
  // };
  ...
  const handleCallback = (start, end) => {
    ...
    props.getSolvedComplain(start_, end_, type);
  };
