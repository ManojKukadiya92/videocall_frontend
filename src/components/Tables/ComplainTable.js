...
const ComplainTable = (props) => {
  ...
  let arr = [];
  useEffect(() => {
    props.getComplain(start, end, type);
    props.getPendingDateList(); // eslint-disable-next-line
  }, []);
  ...
  //   if (date === "all") {
  //     setDate("all");
  //     props.getComplain("all", type);
  //   } else {
  //     setDate(date);
  //     props.getComplain(date, type);
  //   }
  // };
  ...
  useEffect(() => {
    ...
    setData(array); // eslint-disable-next-line
  }, [complain]);

  const handleTypeChange = (type) => {
    if (type === "all") {
      setType("all");
      props.getComplain(start, date, "all");
    } else {
      setType(type);
      props.getComplain(start, end, type);
    }
  ...
  const handleCallback = (start, end) => {
    ...
    props.getComplain(start_, end_, type);
  };
        ...
        <div class="row">
          <div class="card">
            ...
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-12  col-lg-3 mt-3">
