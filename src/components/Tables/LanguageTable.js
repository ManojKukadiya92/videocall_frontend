...
//sweet alert
import { alert, languageWarning, permissionError } from "../../util/alert";
...
const LanguageTable = (props) => {
  ...
  useEffect(() => {
    props.getLanguage(activePage, rowsPerPage); // eslint-disable-next-line
  ...
  const handlePageChange = (pageNumber) => {
    ...
    props.getLanguage(pageNumber, rowsPerPage);
  };
