...
export const getHost = () => (dispatch) => {
  axios
    .get(`/host`)
    .then((res) => {
      dispatch({ type: GET_HOST, payload: res.data.host });
...
export const enableDisableHost = (id) => (dispatch) => {
  axios
    ...
    .then((res) => {
      dispatch({ type: ENABLE_DISABLE_HOST, payload: res.data.host });
    })
    .catch((error) => {
      console.log(error);
    });
...
export const currentWeekAnalytic = (id, day) => (dispatch) => {
  axios
    ...
    .then((res) => {
      dispatch({ type: GET_CURRENT_WEEK_ANALYTIC, payload: res.data.analytic });
    })
    .catch((error) => {
      console.log(error);
    });
...
export const lastWeekAnalytic = (id, day) => (dispatch) => {
  axios
    ...
    .then((res) => {
      dispatch({ type: GET_LAST_WEEK_ANALYTIC, payload: res.data.analytic });
    })
    .catch((error) => {
      console.log(error);
    });
